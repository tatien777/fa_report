...
import base64
import utils.test_auth_2 as test_auth_2
...
def auto_main():
    ...
    def merge_pivot(res_samday,res_no_sameday):
        ...
        return MIS1_fn
    if st.button('Click to run report',key="run"):
...
# login_blocks = test_auth_2.generate_login_block()
# password = test_auth_2.login(login_blocks)

# if test_auth_2.is_authenticated(password):
#     test_auth_2.clean_blocks(login_blocks)
#     auto_main()
# elif password:
